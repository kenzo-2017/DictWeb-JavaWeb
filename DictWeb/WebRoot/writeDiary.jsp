    ...
    <div id="box">
    	...
    	<form name="form1" method="post" action="DiaryServlet?action=preview">
    		<div style="margin:10px;">
    			...
    			<a href="#" onClick="setTemplate('默认')">默认</a>
    			<a href="#" onClick="setTemplate('女孩')">女孩</a>
    			<a href="#" onClick="setTemplate('怀旧')">怀旧</a>
    			<input id="template" name="template" type="hidden" value="默认" />
    		</div>
    		<div style="padding:10px" class="title">
    			请输入日记标题：
    			<input name="title" type="text" size="30" maxlength="30" value="请在此输入标题" onFocus="this.select()" />
    		</div>
    			...
    			<div style="width:600px;height:600px;">
    				<ul id="gridLayout">
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								...
    								<li><a href="#" onClick="document.getElementByName('content')[0].value='工作完成了'">◎ 工作完成了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[0].value='我还活着'">◎ 我还活着</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[0].value='瘦了'">◎ 瘦了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[0].value='好多好吃的'">◎ 好多好吃的</a></li>
    							</ul>
    						</div>
    					</li>
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								<li><a href="#" onClick="document.getElementByName('content')[1].value='关心同事了'">◎ 关心同事了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[1].value='问候家人了'">◎ 问候家人了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[1].value='给老人让座'">◎ 给老人让座</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[1].value='忘记了'">◎ 忘记了</a></li>
    							</ul>
    						</div>
    					</li>
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								<li><a href="#" onClick="document.getElementByName('content')[2].value='写工作总结'">◎ 写工作总结</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[2].value='出去旅游'">◎ 出去旅游</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[2].value='继续努力工作'">◎ 继续努力工作</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[2].value='休息一下'">◎ 休息一下</a></li>
    							</ul>
    						</div>
    					</li>
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								<li><a href="#" onClick="document.getElementByName('content')[3].value='效率提高了'">◎ 效率提高了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[3].value='看书了'">◎ 看书了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[3].value='状态好了'">◎ 状态好了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[3].value='不再空想了'">◎ 不再空想了</a></li>
    							</ul>
    						</div>
    					</li>
    					<li>
    					...
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								<li><a href="#" onClick="document.getElementByName('content')[5].value='心情不错'">◎ 心情不错</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[5].value='不给力'">◎ 不给力</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[5].value='幸福'">◎ 幸福</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[5].value='神马都是浮云'">◎ 神马都是浮云</a></li>
    							</ul>
    						</div>
    					</li>
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								<li><a href="#" onClick="document.getElementByName('content')[6].value='她/他写九宫格日记了'">◎ 她/他写九宫格日记了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[6].value='白菜贵了'">◎ 白菜贵了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[6].value='大家都在关注神马'">◎ 大家都在关注神马</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[6].value='新闻联播'">◎ 新闻联播</a></li>
    							</ul>
    						</div>
    					</li>
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								<li><a href="#" onClick="document.getElementByName('content')[7].value='瘦了'">◎ 瘦了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[7].value='胖了'">◎ 胖了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[7].value='健康饮食'">◎ 健康饮食</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[7].value='一日三餐不能少'">◎ 一日三餐不能少</a></li>
    							</ul>
    						</div>
    					</li>
    					<li>
    						<div class="cssContent">
    							<ul id="opt">
    								<li><a href="#" onClick="document.getElementByName('content')[8].value='睡得很好'">◎ 睡得很好</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[8].value='拥有自己的房子'">◎ 拥有自己的房子</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[8].value='忘记了'">◎ 忘记了</a></li>
    								<li><a href="#" onClick="document.getElementByName('content')[8].value='努力做好自己'">◎ 努力做好自己</a></li>
    							</ul>
    						</div>
    					</li>
    				</ul>
    		...
    		<div style="height:30px;padding-left:360px;">
